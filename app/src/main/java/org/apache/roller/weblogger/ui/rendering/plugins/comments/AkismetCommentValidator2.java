 ...
 */
public class AkismetCommentValidator2 implements CommentValidator {
    private static Log log = LogFactory.getLog(AkismetCommentValidator2.class);
    private ResourceBundle bundle;
    private String apikey;

    /** Creates a new instance of AkismetCommentValidator */
    public AkismetCommentValidator2() {
    ...
    AkismetCommentValidator2(String apikey, ResourceBundle resourceBundle) {
        this.apikey = apikey;
